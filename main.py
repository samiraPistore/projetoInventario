...
def atualizar():
    try: 
        ...
        botao_confirmar = Button(frameMeio, command = update, text = "Confirmar".upper(), width = 13, height = 1, font = ('Ivy 8'),  overrelief = RIDGE, relief = RAISED,  bg = co2, fg = co1)
...
e_nome = Entry(frameMeio, width = 30)
...
e_cal = DateEntry(frameMeio, width = 12,  background = 'darkblue', foreground = 'white', boderwidht = 2, year = 2025)
...
botao_carregar = Button(frameMeio, command = escolher_Imagem, compound = CENTER, anchor = CENTER, text = "Carregar".upper(), width = 30, overrelief = RIDGE, fon = ('Ivy 8'), bg = co1, fg = co0)
...
botao_inserir = Button(frameMeio, command = inserir, image = img_add, compound = LEFT, anchor = NW, text = "Adicionar".upper(), width =95, overrelief = RIDGE, fon = ('Ivy 8'), bg = co1, fg = co0)
...
botao_atualizar = Button(frameMeio, command = atualizar, image = img_update, compound = LEFT, anchor = NW, text = "Atualizar".upper(), width =95, overrelief = RIDGE, fon = ('Ivy 8'), bg = co1, fg = co0)
...
botao_deletar = Button(frameMeio,  command = deletar, image = img_delete, compound = LEFT, anchor = NW, text = "Deletar".upper(), width =95, overrelief = RIDGE, fon = ('Ivy 8'), bg = co1, fg = co0)
...
botao_ver = Button(frameMeio,  command = ver_imagem, image = img_item, compound = LEFT, anchor = NW, text = "Ver item".upper(), width =95, overrelief = RIDGE, fon = ('Ivy 8'), bg = co1, fg = co0)
